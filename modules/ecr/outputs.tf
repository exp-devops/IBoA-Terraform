...
output "palms_cede_intg_service_url" {
...
output "palms_cede_liquibase_url" {
  description = "ECR URL for palms-cede-liquibase"
  value       = aws_ecr_repository.repositories["palms-cede-liquibase"].repository_url
}
