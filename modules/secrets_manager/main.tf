...
resource "aws_secretsmanager_secret" "postgres_rds_credentials" {
  name        = "${var.project_name}-${var.project_segment}-${var.project_env}-postgres-rds-credentials"
...
resource "aws_secretsmanager_secret" "mysql_rds_credentials" {
  name        = "${var.project_name}-${var.project_segment}-${var.project_env}-mysql-rds-credentials"
...
resource "aws_secretsmanager_secret_policy" "mysql_rds_credentials" {
